...
test_that("arguments satisfies certain condition and some are not missing", {
  ...
  expect_error(gaSelection(2, list(population, fitnessVec, eliteRate)), "Selection method must be one of 'gaLRselection', 'gaExpSelection', 'gaRWselection', or 'gaTNselection'", fixed=TRUE)
